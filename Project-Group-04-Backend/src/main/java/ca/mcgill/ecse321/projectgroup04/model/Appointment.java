...
public class Appointment {
  ...
  public void setServices(Service aServices) { this.services = aServices; }

  public void setTechnician(GarageTechnician aTechnician) { this.technician = aTechnician; }

  public void setTimeSlot(TimeSlot aNewTimeSlot) { this.timeSlot = aNewTimeSlot; }
