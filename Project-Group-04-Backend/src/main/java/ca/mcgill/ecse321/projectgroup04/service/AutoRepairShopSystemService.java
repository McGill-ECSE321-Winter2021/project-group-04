...
// throw new IllegalArgumentException("User does not exist, please register a
// new account or try again.");
// }
...
// @Transactional
// public Profile createProfile(String aAddressLine, String aPhoneNumber, String
...
// @Transactional
// public Appointment createAppointment(Customer aCustomer, BookableService
// aBookableService,
// GarageTechnicianService aGarageTechnician, TimeSlot aTimeSlot,
// AppointmentReminder aAppointmentReminder,
// Receipt aReceipt) {
...
// @Transactional
// public Appointment bookAppointment(String userId, String serviceName, Date
// date, Integer garageSpot, Time startTime,
...
// getBookableServiceByServiceName(serviceName);
...
// throw new IllegalArgumentException("Please chose a garage sport between 1 and
// 4");
// }
// if (date.before(Date.valueOf(LocalDate.now()))) {
// throw new IllegalArgumentException("Please book an appointment in the
// future");
// }
// for (BusinessHour businessHour : getAllBusinessHours()) {
// if (businessHour.getStartTime().after(startTime) ||
// businessHour.getEndTime().before(endTime)) {
// throw new IllegalArgumentException("This time doesn't fall within business
// hours!");
// }
// }
// for (Appointment appointment : getAppointmentsByDate(date)) {
// if (isOverlap(appointment.getTimeSlot(), startTime, endTime, garageSpot)) {
// throw new IllegalArgumentException("This attempted booking overlaps with
// another!");
// }
// }
// TimeSlot timeSlot = createTimeSlot(startTime, endTime, date, date,
// garageSpot);
// Receipt receipt = createReceipt(bookableService.getPrice());
// GarageTechnicianService garageTechnician =
// getGarageTechnicianById(garageTechnicianId);
// date = Date.valueOf(date.toLocalDate().minusDays(1)); // again get back your
// date object
...
// Appointment appointment = createAppointment(customer, bookableService,
// garageTechnician, timeSlot, appReminder,
// receipt);
// return appointment;
...
// @Transactional
// public Appointment getAppointmentByTimeSlotAndCustomer(TimeSlot aTimeSlot,
// Customer aCustomer) {
...
// @Transactional
// public List<Appointment> getAppointmentsByTechnician(GarageTechnicianService
// garageTechnician) {
...
// @Transactional
// public Appointment
// getAppointmentsByBookableServiceAndCustomer(BookableService service, Customer
// customer) {
// if (customer == null) {
// throw new IllegalArgumentException("Customer can't be null");
// }
...
// }
// return appointmentRepository.findByBookableServicesAndCustomer(service,
// customer);
// }
...
// @Transactional
// public AdministrativeAssistant getAdministrativeAssistantByUserId(String
// userId) {
// return
// administrativeAssistantRepository.findAdministrativeAssistantByUserId(userId);
// }
...
// AdministrativeAssistant existingAssistant =
// getAdministrativeAssistantByUserId(userId);

// if (existingAssistant != null) {
// throw new IllegalArgumentException("Administrative Assistant already
// exists");
// }
// // if (userId == null ) {
...
// }
// AdministrativeAssistant administrativeAssistant = new
...
// return
// administrativeAssistantRepository.findAdministrativeAssistantById(userId);
// }

// @Transactional
// public List<AdministrativeAssistant> getAllAdministrativeAssistants() {
// return (List<AdministrativeAssistant>)
// administrativeAssistantRepository.findAll();
// }
...
// throw new IllegalArgumentException("You have to change the username or
// password or both");
// }
...
// @Transactional
// public List<Car> getCarByModelAndYearAndColor(String model, String year,
// String color) {
...
// @Transactional
// public Customer createCustomer(String userId, String password, List<Reminder>
// reminder, Car car, Profile profile) {
...
// public Customer editCustomer(Customer customer, String Id, String password,
// List<Reminder> reminders, Car car,
// Profile profile) {
...
// @Transactional
// public void addAppointmentReminderToCustomer(Customer customer,
...
// @Transactional
// public TimeSlot createTimeSlot(Time startTime, Time endTime, Date startDate,
// Date endDate, Integer garageSpot) {
...
// @Transactional
// public TimeSlot getTimeSlotByStartDateAndStartTime(Date startDate, Time
// startTime) {
// return timeSlotRepository.findTimeSlotByStartDateAndStartTime(startDate,
// startTime);
// }
...
// public AppointmentReminder createAppointmentReminder(Date date, Time time,
// String message) {
// if (message == "") {
...
// @Transactional
// public BookableService createBookableService(String name, int price, int
// duration) {

// BookableService existingService = getBookableServiceByServiceName(name);

// if (existingService != null) {
// throw new IllegalArgumentException("Bookable Service with this name already
// exists");
// }
...
// if (existingService != null) {
// throw new IllegalArgumentException("Emergency Service with this name already
// exists");
// }
...
// public EmergencyService bookEmergencyService(String bookingName, String
// serviceName, String aLocation,
// String userId, FieldTechnician aFieldTechnician) {

// EmergencyService bookableEmergencyService = new EmergencyService();
// EmergencyService emergencyService =
// getEmergencyServiceByServiceName(serviceName);
...
// if (aFieldTechnician.getIsAvailable() == false) { // if field technician is
// unavailable
// throw new IllegalArgumentException("Field Technician is currently
// unavailable");
// }
...
// EmergencyService emergencyService =
// emergencyServiceRepository.findEmergencyServiceByServiceId(serviceId);

// if (emergencyService == null) {
// throw new IllegalArgumentException("No Emergency Service with such ID
// exist!");
// }
...
// {
// return (List<EmergencyService>)
// emergencyServiceRepository.findByCustomer(customer);
// }
...
// @Transactional
// public EmergencyService editEmergencyService(EmergencyService
// emergencyService, String name, int price) {

// if (name == emergencyService.getName() && price ==
// emergencyService.getPrice()) {
// throw new IllegalArgumentException("You have to edit one of the fields");
// }
// EmergencyService existingEmergencyService =
// getEmergencyServiceByServiceName(name);
// if (existingEmergencyService != null) {
// throw new IllegalArgumentException("An emergency service with this name
// already exists");
// }
...
// @Transactional
// public EmergencyService deleteEmergencyService(EmergencyService
// emergencyService) {
...
// @Transactional
// public EmergencyService endEmergencyService(EmergencyService
// emergencyService) {
...
// @Transactional
// public GarageTechnicianService createGarageTechnician(String name) {

// if (name == "") {
// throw new IllegalArgumentException("Name can't be empty");
// }
// GarageTechnicianService existingGarageTechnician =
// getGarageTechnicianByName(name);
// if (existingGarageTechnician != null) {
// throw new IllegalArgumentException("Garage Technician with this name already
// exists");
// }

// GarageTechnicianService garageTechnician = new GarageTechnicianService();
...
// @Transactional
// public List<GarageTechnicianService> getAllGarageTechnicians() {
// return (List<GarageTechnicianService>) garageTechnicianRepository.findAll();
// }

// @Transactional
// public GarageTechnicianService getGarageTechnicianById(Long technicianId) {
// GarageTechnicianService garageTechnician = garageTechnicianRepository
// .findGarageTechnicianByTechnicianId(technicianId);
// if (garageTechnician == null) {
...
// @Transactional
// public GarageTechnicianService getGarageTechnicianByName(String name) {

// String trim = new String(name.trim());
// System.out.println(trim + "v");
// GarageTechnicianService garageTech = null;
// for (GarageTechnicianService garageTechnician :
// garageTechnicianRepository.findAll()) {
...
// throw new IllegalArgumentException("Field Technician with this name already
// exists");
// }
...
// return
// fieldTechnicianRepository.findFieldTechnicianByTechnicianId(technicianId);
// }
...
// {
// List<EmergencyService> emergencyServices = (List<EmergencyService>)
...
// throw new IllegalArgumentException("The field technician is assigned to an
// emergency service!");
// }
// }
...
// @Transactional
// public Business createBusiness(String aName, String aAddress, String
// aPhoneNumber, String aEmailAddress,
...
// public Business updateBusinessInformation(Long Id, String aName, String
// aAddress, String aPhoneNumber,
// String aEmailAddress, List<BusinessHour> aBusinessHours, List<TimeSlot>
// regular) {

// Business business = getBusinessById(Id);

// if (business == null) {
// throw new IllegalArgumentException("The business with this Id doesn't
// exist");
// }
...
// @Transactional
// public BusinessHour createBusinessHour(String aDayOfWeek, Time aStartTime,
// Time aEndTime) {
...
// "Business hours with this start time already exist, update end time
// instead");
// }
// }
// }
...
// throw new IllegalArgumentException("Business hour start time cannot equal to
// end time");
// }
...
// public BusinessHour updateBusinessHour(Long id, String dayOfWeek, Time
...
// public Boolean deleteBusinessHour(BusinessHour businessHour, Business
// business) {
...
// @Transactional
// public CheckupReminder createCheckupReminder(Date aDate, Time aTime, String
// aMessage) {
...
// @Transactional
// public CheckupReminder editCheckupReminder(Long id, Date aDate, Time aTime,
// String aMessage) {
// CheckupReminder checkupReminder =
// checkupReminderRepository.findByReminderId(id);
...
// }
// }
// throw new IllegalArgumentException("No Profile with such First Name and Last
// Name");
// }
...
// if (profile == null) {
// throw new IllegalArgumentException("This customer does not have a valid
// profile");
// }
...
// public boolean isOverlap(TimeSlot timeSlot1, Time startTime, Time endTime,
// Integer garageSpot) {
...
// public Appointment deleteAppointment(Appointment appointment, LocalTime
// testTime, LocalDate testDate) {
// if (appointment == null) {
// throw new IllegalArgumentException("No appointment with such ID exist!");
// }
...
// throw new IllegalArgumentException("Cannot cancel appointment less than
// 24hours!");
// }
...
// public AppointmentReminder deleteAppointmentReminder(AppointmentReminder
// appointmentReminder) {
// appointmentReminderRepository.delete(appointmentReminder);
...
// deleteAdministrativeAssistant(AdministrativeAssistant
// administrativeAssistant) {
...
// public GarageTechnicianService deleteGarageTechnician(GarageTechnicianService
// garageTechnician) {
...
// throw new IllegalArgumentException("This garage technician still has
// appointments");
// }
...
// public AppointmentReminder editAppointmentReminder(AppointmentReminder
// appointmentReminder, String message) {
...
// public BookableService editBookableService(BookableService bookableService,
// String name, int duration, int price) {
// if (name == bookableService.getName() && duration ==
// bookableService.getDuration()
// && price == bookableService.getPrice()) {
// throw new IllegalArgumentException("You have to edit one of the fields");
// }
// BookableService existingBookableService =
// getBookableServiceByServiceName(name);
// if (existingBookableService != null) {
// throw new IllegalArgumentException("A bookable service with this name already
// exists");
// }
// bookableService.setName(name);
// bookableService.setDuration(duration);
...
// public AdministrativeAssistant
// editAdministrativeAssistant(AdministrativeAssistant administrativeAssistant,
// String userId, String password) {
// if (userId == administrativeAssistant.getUserId() && password ==
