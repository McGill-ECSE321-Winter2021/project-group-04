...
public class AppointmentDto {
	  ...
	  public AppointmentDto(CustomerDto aCustomer,BookableServiceDto aBookableService,GarageTechnicianDto aGarageTechnician,TimeSlotDto aTimeSlot, AppointmentReminderDto aReminder,ReceiptDto aReceipt) {
		  customer=aCustomer;
